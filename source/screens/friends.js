...
console.log(this.state.ben)
  ...
  console.log('contact fetch done')
    ...
    async componentWillMount(){
        var print = await AsyncStorage.getItem('friends').length;
        console.log(print)  
      
       this.contacts()
       const result= await AsyncStorage.getItem('friends')
     ...
     async submit(){
        ...
        try {
            ...
            let value = await AsyncStorage.getItem('friends');
            if (value != null){
        ...
        AsyncStorage.setItem('friends',JSON.stringify(value))
        ...
        //for checking purposes
           ...
           // Error retrieving data
               ...
               //let value = await AsyncStorage.getItem('friends').length;
     ...
     async removeItem(props){
        ...
        AsyncStorage.setItem('friends',JSON.stringify(forA))
        //alert('removed'+props)
